...
#if UNITY_EDITOR
        public static void UpgradeAsset(EntityId assetEntityId)
        {
            if (EditorUtility.EntityIdToObject(assetEntityId) is not UniversalRenderPipelineGlobalSettings asset)
                return;
