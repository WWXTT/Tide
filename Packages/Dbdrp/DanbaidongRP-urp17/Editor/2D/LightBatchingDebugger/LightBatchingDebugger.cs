...
namespace UnityEditor.Rendering.Universal
{
    internal class LightBatchingDebugger : EditorWindow
    {
        ...
        private ulong cachedSceneHandle;
        ...
        private bool IsDirty()
        {
            ...
            isDirty |= cachedSceneHandle != SceneManager.GetActiveScene().handle.GetRawData();
        ...
        {
            cachedSceneHandle = SceneManager.GetActiveScene().handle.GetRawData();
