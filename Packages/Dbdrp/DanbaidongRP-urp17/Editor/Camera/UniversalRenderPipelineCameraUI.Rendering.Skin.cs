    ...
    static partial class UniversalRenderPipelineCameraUI
    {
        public partial class Rendering
        {
            public class Styles
            {
                ...
                public static readonly GUIContent taaBaseBlendFactor = EditorGUIUtility.TrTextContent("Base Blend Factor", "Determines how much the history buffer is blended together with current frame result. Higher values means more history contribution, which leads to better anti aliasing, but also more prone to Performing.");
                ...
                public static readonly GUIContent taaVarianceClampScale = EditorGUIUtility.TrTextContent("Variance Clamp Scale", "Determines the strength of the history color rectification clamp. Lower values can reduce Performing, but produce more flickering. Higher values reduce flickering, but are prone to blur and Performing.");
