...
namespace FIMSpace.FTextureTools
{
    public abstract class FTextureProcessWindow : EditorWindow
    {
        ...
        static GUIStyle rTipStyle = null;
        static readonly Color rTipColor = new Color( .75f, .75f, .75f, .75f );
        public static GUIStyle GetRightTipStyle
        {
            get
            {
                if ( rTipStyle == null || rTipStyle.normal.textColor != rTipColor )
                {
                    rTipStyle = new GUIStyle( EditorStyles.label ) { alignment = TextAnchor.MiddleRight };
                    rTipStyle.normal.textColor = rTipColor;
                    rTipStyle.fontSize = 10;
                }
        ...
        protected void OnGUIFooter()
        {
            ...
            EditorGUILayout.LabelField("FImpossible Creations " + System.DateTime.Now.Year, GetRightTipStyle );
            EditorGUI.indentLevel--;
        }
