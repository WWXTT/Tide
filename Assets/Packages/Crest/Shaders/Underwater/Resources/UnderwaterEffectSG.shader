...
Shader "Hidden/Crest/Underwater/Underwater Effect SG"
{
	HLSLINCLUDE
	#pragma target 4.5
	#pragma vertex Vert
	...
	#pragma multi_compile_local_fragment __ CREST_CAUSTICS_ON
	#pragma multi_compile_local_fragment __ CREST_FLOW_ON
	#pragma multi_compile_local_fragment __ CREST_FOAM_ON
...
#endif
			#include "../UnderwaterEffectSG.hlsl"
			ENDHLSL
		}
	...
	SubShader
	{
		...
		Pass
		{
			...
			// whether to skip the horizon calculation.
			#pragma multi_compile_local_fragment __ _FULL_SCREEN_EFFECT
			#include "../UnderwaterEffectURP.hlsl"
#if UNITY_VERSION >= 202230
			#include_with_pragmas "Packages/com.unity.render-pipelines.core/ShaderLibrary/FoveatedRenderingKeywords.hlsl"
			#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/FoveatedRendering.hlsl"
#endif
